    ...
    return (
        <section id="about" className="min-h-screen">
            <div className="w-auto h-auto rounded-bl-4xl rounded-br-4xl gap-2">
                ...
                {/* <div className='py-40 px-10 gap-6 flex space-y-1.5 flex-col  items-center text-center lg:flex lg:flex-row-reverse lg:space-x-6 lg:text-left shadow-2xl rounded-b-4xl text-balance'>
                    <motion.h1
                        variants={SlideUp(0.2)}
                        viewport={{ amount: 0.5, once: true }}
                    ...
                    <motion.p
                        ...
                        initial='hidden'
                        whileInView='visible'
                        className="text-balance text-3xl  mt-3 text-black">
                ...
                <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20 mt-20">

                    {/* Text Section */}
                    <div className="space-y-5">
                        <div>
                            <p className="text-green-600 font-semibold uppercase tracking-wide mb-2">Our Story</p>
                    ...
                    <div className="relative w-full h-full">
                        <div className="rounded-xl overflow-hidden shadow-lg">
                            <Image
                                src="/servis trafo 1.jpg"
                                alt="Gunbuster Nickel Industry"
                                width={500}
                                height={500}
                                className="w-full object-cover sm:h-full md:h-70"
                            />
                        </div>
                        <div className="absolute -bottom-20 left-0 w-4/5 rounded-xl overflow-hidden shadow-lg hidden lg:block">
                            <Image
                                src="/trafo 5.jpg"
